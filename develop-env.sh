...
docker run --name my-nginx -d --restart=always -p 80:80 -v /data/webroot:/usr/share/nginx/html -v /data/etc/nginx/conf.d:/etc/nginx/conf.d -v /data/etc/nginx/conf.d/default.conf:/etc/nginx/default.conf -v /data/log/nginx:/var/log/nginx --link my-php:php nginx
